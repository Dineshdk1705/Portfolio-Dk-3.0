...
export default function Skills({}: Props) {
  return (
    <div className="relative flex min-h-screen flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 xl:space-y-0 mx-auto px-10 justify-center items-center">
      ...
      {/* <h3 className="absolute top-36 uppercase text-sm text-gray-500 tracking-[3px]">
        Will add it later : Hover over a skill for proficiency
      </h3> */}
